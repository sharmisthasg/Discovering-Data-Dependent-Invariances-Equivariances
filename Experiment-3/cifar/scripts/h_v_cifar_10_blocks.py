# -*- coding: utf-8 -*-
"""H_V_CIFAR-10_Blocks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IunSx2-dNjO7YZ5Nybx8_wwqYe7DaijJ
"""
...
def main():
    torch.manual_seed(696)
    logging.basicConfig(filename="reports/H_V_block_cifar_MLP.log",
    ...
    model.load_state_dict(torch.load("models/H_V_block_cifar_MLP" + ".pt"))
    # training-phase
    print('Training ....')
    for epoch in range(20):
        ...
        if loss < optimum_loss and val_loss < optimum_val_loss :
            ...
            torch.save(model.state_dict(), "models/H_V_block_cifar_MLP" + ".pt")
...
"""RESULTS ON TEST DATA [45 epochs]:

precision: 0.4443373291430343

recall: 0.4479773687816725

F1: 0.4403976969459544

accuracy: 0.46484375

RESULTS ON TEST DATA [65 epochs]:

precision: 0.46579914138737666

recall: 0.4666068040640313

F1: 0.46321780639834975

accuracy: 0.484375

RESULTS ON TEST DATA [85]:

precision: 0.47954284158230476

recall: 0.4784113316644845

F1: 0.47362260162355846
