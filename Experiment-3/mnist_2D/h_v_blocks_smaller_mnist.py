# -*- coding: utf-8 -*-
"""H_V_Blocks_smaller_MNIST.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18-1l1ifm2A3N8SG0OXNfX0lBEzyI3Fr_
"""
...
def main():
    torch.manual_seed(696)
    logging.basicConfig(filename="reports/H_V_block_bias_MNIST.log",
    ...
    model.load_state_dict(torch.load("models/H_V_block_bias_MNIST" + ".pt"))
    ...
    for epoch in range(20):
        ...
        if loss < optimum_loss and val_loss < optimum_val_loss :
            ...
            torch.save(model.state_dict(), "models/H_V_block_bias_MNIST" + ".pt")
...
"""RESULTS ON TEST DATA [10 epochs]:

precision: 0.9395007677507679

recall: 0.9387208232188019

F1: 0.9383073711647875

accuracy: 0.94140625

RESULTS ON TEST DATA [20 epochs]:

precision: 0.9613548035701737

recall: 0.9642454797217193

F1: 0.9623949682768874

accuracy: 0.96484375

RESULTS ON TEST DATA [30 epochs]:

precision: 0.9675452797606499

recall: 0.9685933058086759

F1: 0.9678191609424595
...
precision: 0.9818776641091219

recall: 0.9854745744451627

F1: 0.9834426926465467
