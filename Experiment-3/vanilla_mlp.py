...
Original file is located at
    https://colab.research.google.com/drive/1k9LqAWf7kL_xYPTBM4nlaxgiwdDBfyrT
"""
...
def custom_loss_fn(criterion, y_pred, y, hp, model):
    blocks = torch.hsplit(model.linear_1.weight,49)
...
def main():
    torch.manual_seed(696)
    logging.basicConfig(filename="reports/2_layer_10_vanilla_MLP.log",
    ...
    for epoch in range(50):
        ...
        if loss < optimum_loss and val_loss < optimum_val_loss :
            ...
            torch.save(model.state_dict(), "models/2_layer_10_vanilla_MLP" + ".pt")

    # test-phase
    print('Testing ...')
    print('\nRESULTS ON TEST DATA:')
    logger.info('\nRESULTS ON TEST DATA:')
    model.load_state_dict(torch.load("models/2_layer_10_vanilla_MLP" + ".pt"))
